...
__ATTENTION. You must launch this version of the application to deploy storage components to the production environment of kubespace-wiki.js__.

By releasing the storage components separately you are guaranteed.
- You can kill the kubespace-wiki.js application without losing the data and use the computing capacity of your environment for other functions.
