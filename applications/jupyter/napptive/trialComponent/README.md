...
The davmaio-jupytertest instance automatically gets a public URL. If the application is APP_OK, copy the ingress link in your browser. 

```
https://davmaio-jupytertest-<active-namespace>.apps.playground.napptive.dev
```
